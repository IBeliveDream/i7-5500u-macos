# i7-5500u-macos
## 先总结：将就能用，显卡（屏蔽独显，核显浏览器显示有点小瑕疵，谷歌浏览器显示有问题），网卡（需要外接usb网卡）。
...
目前碰到的问题， 
* 板载网卡，无线无效，  
* usb可以用，但是想要联网（使用手机的usb网络共享）需要下载 瑞昱的驱动 地址 http://www.comfast.cn/index.php?m=content&c=index&a=show&catid=30&id=213 好像是这个解决了usb驱动，usb外接无线网卡（网上最便宜的usb网卡可以用，型号忘记了【当时在windows电脑好像也下载过网卡驱动的，但是苹果系统直接驱动成功】），手机usb网络共享好用，蓝牙网络可以用（慢）。
* 声音输出没啥问题，录音有电流杂音。
